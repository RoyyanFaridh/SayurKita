...
export default function Register() {
  ...
  // Simulasi navigasi — ganti dengan router.push('/verify') di Next.js / React Router
  const handleSubmit = () => {
          ...
          <div className={styles.stepper}>
            {steps.map((s, i) => (
              <div key={s.num} className={styles.stepperItem}>
                <div className={`${styles.stepCircle} ${ACTIVE === s.num ? styles.stepActive : ''}`}>
                  {s.num}
                </div>
                <span className={`${styles.stepLabel} ${ACTIVE === s.num ? styles.stepLabelActive : ''}`}>
                  {s.label}
                </span>
